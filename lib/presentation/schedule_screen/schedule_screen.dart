...
class ScheduleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AppScopeWidget.of(context)
        .analyticsHelper
        .sendCurrentScreenToAnalytics('Screen', 'Schedule', 'Schedule pages screen');
...
class ScheduleScreenWidgetState extends State<ScheduleScreenWidget> {
            ...
            title: Column(
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: Text(GetDigitFromString(text: list[i].data).execute().toString(),
  ...
  void pageChanged(int index) {
    if (hasVibrator && AppScopeWidget.of(context).appSettings.isVibrationEnabled) {
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
        ...
        systemNavigationBarIconBrightness:
            Theme.of(context).brightness == Brightness.dark ? Brightness.light : Brightness.dark));
    if (presenter == null) {
      presenter = ScheduleScreenPresenter(this, AppScopeWidget.of(context), Parser());
            ...
            floatingActionButton: AnimatedOpacity(
              ...
              child: Padding(
                ...
                child: FloatingActionButton.extended(
                  ...
                  label: Text(
                      (presenter.currentWeek == 0 ? 'Текущая' : '${presenter.currentWeek + 1}') +
                          ' неделя',
                  ...
                  onPressed: () async {
                    ...
                    showModalBottomSheet(
                      ...
                      AppScopeWidget.of(context).remoteConfig.then((remoteConfig) {
                        AppScopeWidget.of(context).adManager.showMainBanner(remoteConfig);
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            presenter.userScheduleInfo.then((userScheduleInfo) {
                              presenter.appScopeData.personInfo().then((personInfo) {
                                showModalBottomSheet(
                                    isScrollControlled: true,
                                    context: context,
                                    shape: RoundedRectangleBorder(
      ...
      case ScheduleStatus.Empty:
        return Center(
            child: Text('Расписание отсутствует',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: FONT_COLOR_2)));
        break;
        ...
        children: <Widget>[
          ...
          Expanded(
            child: SmartRefresher(
              ...
              header: CustomHeader(builder: (BuildContext context, RefreshStatus status) {
